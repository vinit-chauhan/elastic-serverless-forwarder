...
class TestRecordId(TestCase):
    def test_kinesis_id_less_than_512bytes(self) -> None:
        ...
        approximate_arrival_timestamp: int = int(datetime.datetime.now(datetime.timezone.utc).timestamp() * 1000)
    ...
    def test_s3_id_less_than_512bytes(self) -> None:
        event_time: int = int(datetime.datetime.now(datetime.timezone.utc).timestamp() * 1000)
    ...
    def test_sqs_id_less_than_512bytes(self) -> None:
        sent_timestamp: int = int(datetime.datetime.now(datetime.timezone.utc).timestamp() * 1000)
    ...
    def test_cloudwatch_id_less_than_512bytes(self) -> None:
        event_timestamp: int = int(datetime.datetime.now(datetime.timezone.utc).timestamp() * 1000)

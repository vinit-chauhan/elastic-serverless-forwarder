...
class TestIPFIXECSIntegration(unittest.TestCase):
    ...
    def create_simple_ipfix_stream(self) -> BytesIO:
        ...
        data_record = struct.pack(
            "!II", int.from_bytes([192, 168, 1, 1], "big"), int.from_bytes([10, 0, 0, 1], "big")  # sourceIPv4Address
    ...
    def test_ipfix_to_ecs_pipeline(self):
        ...
        wrapped_event = {"fields": {"message": ipfix_record}}
    ...
    def _validate_ip_addresses(self, ecs_record: dict, expected_source: str, expected_dest: str) -> None:
    ...
    def test_simple_ipfix_ecs_pipeline(self):
        ...
        # Process through ECS processor (wrap in expected format)
        wrapped_event = {"fields": {"message": sample_ipfix_record}}
        ecs_result = self.ecs_processor.process(wrapped_event)
    ...
    def test_end_to_end_ipfix_ecs_integration(self):
        ...
        test_flows = [("192.168.1.100", "10.0.0.50"), ("172.16.0.10", "8.8.8.8"), ("10.0.1.100", "172.217.16.142")]
        ...
        for source_ip, dest_ip in test_flows:
            with self.subTest(source=source_ip, destination=dest_ip):
                ...
                ipfix_record = {
                    ...
                    "header": {"export_time": self.test_export_time, "sequence_number": self.test_sequence_number},
                }
